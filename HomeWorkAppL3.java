...
//  Вспомогательный метод. Печать  одномерного массива (для заданий 1-3)
    public static void readArray(String msg, int[] inputArray) {
